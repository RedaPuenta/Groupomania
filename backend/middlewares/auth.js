...
module.exports = (req, res, next) => {
    ...
    try {
        ...
        //* Vérifier les droits pour la modification, la suppression d'un utilisateur et la récupération d'informations (INFO)
        //* Si il y a "userIdVerif" dans les paramètres de la requête et que celui ci est différent de l'émetteur ...
            ...
            db.query(dbRequest.privilegeUser(userIdDecoded), function(error, results){
            ...
            db.query(dbRequest.privilegeUser(userIdDecoded), function(error, results){
                ...
                if(error == null) {
                    ...
                    //* Sinon ...
                        ...
                        db.query(dbRequest.selectAuthComments(commentsId), function(error, results){
            ...
            db.query(dbRequest.privilegeUser(userIdDecoded), function(error, results){
                ...
                if(error == null) {
                    ...
                    //* Sinon ...
                        ...
                        db.query(dbRequest.selectAuthPost(postId), function(error, results){
